...
class MarkCodeInfo(BaseModel):
    ...
    unknown: str | None = Field(min_length=1, max_length=32)
    ...
    gs_10: str | None = Field(min_length=1, max_length=38)
    gs_1m: str | None = Field(min_length=1, max_length=200)
    short: str | None = Field(min_length=1, max_length=38)
